...
describe("calculateInsurancePremium", () => {
	...
	it("should throw TRPCError if actualRate > 49999", () => {
		expect(() => calculateInsurancePremium(50000, 1000, true)).toThrow(
			new TRPCError({
				code: "BAD_REQUEST",
	...
	it("should throw TRPCError if actualRate > 5000 and insurance not selected", () => {
		expect(() => calculateInsurancePremium(5001, 1000, false)).toThrow(
			new TRPCError({
				code: "BAD_REQUEST",
				message:
	...
	it("should calculate premium and compensation for actual rate ₹1-₹2,499", () => {
		const result = calculateInsurancePremium(2000, undefined, true);
		expect(result.insurancePremium).toBe(100);
		expect(result.compensationAmount).toBe(2000); // 100% of actual rate
	});

	it("should calculate premium and compensation for actual rate ₹2,500-₹5,000", () => {
		const result = calculateInsurancePremium(3000, undefined, true);
		expect(result.insurancePremium).toBe(100);
	...
	it("should calculate premium and compensation for actual rate ₹5,001-₹12,999", () => {
		const result = calculateInsurancePremium(6000, undefined, true);
		expect(result.insurancePremium).toBeCloseTo(120); // 2% of 6000
		expect(result.compensationAmount).toBeCloseTo(4800); // 80% of 6000
	});

	it("should calculate premium and compensation for actual rate ₹13,000-₹21,999", () => {
		// Test at lower bound
		let result = calculateInsurancePremium(13000, undefined, true);
		expect(result.insurancePremium).toBeCloseTo(13000 * 0.021);
		expect(result.compensationAmount).toBeCloseTo(13000 * 0.58);

		// Test at upper bound
		result = calculateInsurancePremium(21999, undefined, true);
		expect(result.insurancePremium).toBeCloseTo(21999 * 0.029);
		expect(result.compensationAmount).toBeCloseTo(21999 * 0.78);
	});

	it("should calculate premium and compensation for actual rate ₹22,000-₹26,999", () => {
		// Test at lower bound
		let result = calculateInsurancePremium(22000, undefined, true);
		expect(result.insurancePremium).toBeCloseTo(22000 * 0.03);
		expect(result.compensationAmount).toBeCloseTo(22000 * 0.51);

		// Test at upper bound
		result = calculateInsurancePremium(26999, undefined, true);
		expect(result.insurancePremium).toBeCloseTo(26999 * 0.03);
		expect(result.compensationAmount).toBeCloseTo(26999 * 0.55);
	});

	it("should calculate premium and compensation for actual rate ₹27,000-₹49,999", () => {
		const result = calculateInsurancePremium(30000, undefined, true);
	...
	it("should return 0 premium and compensation if insurance not selected and not mandatory", () => {
		const result = calculateInsurancePremium(1000, 500, false);
