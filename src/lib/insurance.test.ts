...
describe("calculateInsurancePremium", () => {
	...
	it("should throw TRPCError if actualRate > 25000 and insurance not selected", () => {
	...
	it("should not throw TRPCError if actualRate is between 5001 and 25000 and insurance not selected", () => {
