	...
	return (
		<div className="min-h-screen">
			<main className="container mx-auto min-h-[90vh] px-4 py-12">
				<SectionHeader
					title="Our Services"
					description="Fast, Reliable, and Secure Courier Services"
					className="mb-12 text-center"
					titleClassName="mb-12 font-bold text-4xl text-blue-950"
					descriptionClassName="mb-4 text-blue-950 text-xl"
				/>
