      ...
      <div className="relative flex w-full flex-col items-center justify-between gap-2 md:gap-16">
        ...
        <div className="flex w-full flex-col items-center justify-between gap-2 md:gap-16">
          <div className="z-10 flex items-center justify-center">
            <div
              className={cn(
                "group rounded-full border border-blue-300 bg-cyan-500/20 text-base text-emerald-950 transition-all duration-300 ease-in hover:cursor-pointer hover:bg-neutral-200/80 dark:border-white/5 dark:bg-neutral-900/80 dark:text-white/80 dark:hover:bg-neutral-800/80",
                "backdrop-blur-sm"
              )}
            >
